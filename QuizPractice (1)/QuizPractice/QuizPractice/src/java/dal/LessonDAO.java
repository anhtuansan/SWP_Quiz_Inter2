...
public class LessonDAO extends DBContext {
    ...
    public List<Lesson2> getLessonsBySubjectWithPaging(int subjectId, int page, int recordPerPage, String name, Integer status, String type) {
        List<Lesson2> lessons = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Lesson2 lesson = new Lesson2(id, name2, creatorId, updateAt, createdAt, status2, content, media, lessonIndex, type2);
                lessons.add(lesson);
            }
    ...
    public boolean updateStatus(int status, int lessonId) {
     ...
     public Lesson2 getLessonById(int lessonId) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Lesson2 lesson = new Lesson2(id, name, creator_id, update_at, created_at, status, content, media, lessonIndex, Type);
