...
<html lang="en">
    ...
    <body>
        ...
        <section class="postDetail">
            <h1 class="heading text-center">Blog Detail</h1>
                    ...
                    <div class="col-md-6">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="brief" class="form-control" rows="3" placeholder="Enter brief info"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="content" class="form-control" rows="5" placeholder="Enter content"></textarea>
                            </div>
